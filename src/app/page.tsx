      ...
      <main className="relative z-10 min-h-screen flex flex-col items-center justify-center gap-10 p-4 overflow-hidden">
        <div className="flex flex-col items-center justify-center w-full">
          ...
          <div className="flex flex-col items-center justify-center w-full">
            ...
            <p className="bg-gradient-to-r from-white from-20% to-zinc-600 bg-clip-text text-transparent drop-shadow-lg">
              Designer & Videomaker
            </p>
          </div>
        </div>
        ...
        <div className=" w-full max-w-xs space-y-4">
          {links.map((link) => (
            <Link
              key={link.url}
              href={link.url}
              className="block p-[1px] rounded-lg bg-gradient-to-l from-white from-65% to-zinc-600"
            >
